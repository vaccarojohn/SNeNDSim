...
# INPUT_START=$1
INPUT_EDEPSIM=/sdf/data/neutrino/jvaccaro/SNeNDSens/edepsim/NueArCCdirt_processed
ROTATED_OUTPUT=/sdf/data/neutrino/jvaccaro/SNeNDSens/gampixpy/NueArCCdirt
...
COMMAND="python3 ${GAMPIXROOT}/rotate_to_experimental_coordinates.py ${TMP_GAMPIXPY_OUTPUT} -o ${ROTATED_OUTPUT}/nueArCC_sns_g4_gampixpy_${FORMATTED}.h5 -d ${GAMPIXROOT}/gampixpy/detector_config/coh_250.yaml"
