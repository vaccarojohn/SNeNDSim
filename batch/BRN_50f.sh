...
# INPUT_START=$1
INPUT_EDEPSIM=/sdf/data/neutrino/jvaccaro/SNeNDSens/edepsim/BRN
ROTATED_OUTPUT=/sdf/data/neutrino/jvaccaro/SNeNDSens/gampixpy/BRN
FORMATTED=$(printf -v formatted_num "%04d" "$((SLURM_ARRAY_TASK_ID))"; echo "$formatted_num")
...
COMMAND="python3 ${GAMPIXROOT}/batch_sim.py "${INPUT_EDEPSIM}/BRN_g4_${FORMATTED}.h5" -o ${TMP_GAMPIXPY_OUTPUT} -r ${GAMPIXROOT}/gampixpy/readout_config/GAMPixD.yaml -d ${GAMPIXROOT}/gampixpy/detector_config/coh_250.yaml"
...
COMMAND="python3 ${GAMPIXROOT}/rotate_to_experimental_coordinates.py ${TMP_GAMPIXPY_OUTPUT} -o ${ROTATED_OUTPUT}/BRN_g4_gampixpy_${FORMATTED}.h5 -d ${GAMPIXROOT}/gampixpy/detector_config/coh_250.yaml"
