...
if __name__ == "__main__":
    for i in range(10):
        ...
        f = h5py.File(infile_dir + '/nueArCC_sns_yDir_g4_000' + str(i) + '.h5', 'r')
    ...
    np.savez_compressed(outfile_dir + '/primary_particles.npz', emult=data['electron']['mult'], eenergy=data['electron']['energy'], 
    ...
    print("Data successfully written to file primary_particles.npz!")
