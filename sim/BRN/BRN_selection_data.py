...
if __name__ == "__main__":
    ...
    np.savez_compressed(outfile_dir + '/BRN_selection_data_new.npz', pmaxe=data_pmaxe, crt=data_crt, light=data_light, tmin=data_tmin, tmax=data_tmax, trms=data_trms, tseg=data_tseg, tdiff=data_tdiff)
    
    print("Data successfully written to file BRN_selection_data_new.npz!")