...
if __name__ == "__main__":
    ...
    np.savez_compressed(outfile_dir + '/cosmics_segment_test_data.npz', lengths=data_lengths, x_start=data_x_start, x_end=data_x_end, y_start=data_y_start, 
    ...
    print("Data successfully written to file cosmics_segment_test_data.npz!")