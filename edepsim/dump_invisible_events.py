...
if __name__ == "__main__":
    for category in categories:
        ...
        np.savez_compressed(category + '/' + file_dir + '/' + category + '_segment_data_reduced.npz', fenergy=segment_data['fenergy'][visible_events_np],
        ...
        np.savez_compressed(category + '/' + file_dir + '/' + category + '_vertex_data_reduced.npz', e01cm=vertex_data['e01cm'][visible_events_np],
