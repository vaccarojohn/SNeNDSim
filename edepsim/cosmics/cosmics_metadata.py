...
if __name__ == "__main__":
    ...
    np.savez_compressed(outfile_dir + '/cosmics_metadata.npz', event_ids=data_event_ids, file_ids=data_file_ids)
    
    print("Data successfully written to file cosmics_metadata.npz!")