...
if __name__ == "__main__":
    ...
    np.savez_compressed(outfile_dir + '/cosmics_trajectory_data.npz', echanges=data_echanges, lengths=data_lengths, palengths=data_palengths, 
                                                                     pslengths=data_pslengths, pflengths=data_pflengths)
    
    print("Data successfully written to file cosmics_trajectory_data.npz!")