...
edepsim_infile_dir = '/sdf/data/neutrino/jvaccaro/CosmicFlux_processed'
gampix_infile_dir = '/sdf/data/neutrino/jvaccaro/CosmicFlux_gampixpy'
...
if __name__ == "__main__":
    ...
    for j in range(9, 12):
        ...
        for i in range(j*100, (j + 1)*100):
            ...
            with h5py.File(edepsim_infile_dir + '/CosmicFlux_g4_' + format(i, "04") + '-processed.h5', 'r') as f, h5py.File(gampix_infile_dir + '/CosmicFlux_g4_gampixpy_' + format(i, "04") + '.h5', 'r') as g:
                temp_genergy = [0, 0, 0]
        ...
        np.savez_compressed(outfile_dir + '/cosmics_segment_data_' + format(j, "04") + '.npz', fenergy=data_fenergy, senergy=data_senergy, aenergy=data_aenergy,
                            pfenergy=data_pfenergy, psenergy=data_psenergy)
        del data_fenergy, data_senergy, data_aenergy, data_pfenergy, data_psenergy
        print("Data successfully written to file cosmics_segment_data_" + format(j, "04") + ".npz!")