...
metadata_infile_dir = '/sdf/home/j/jvaccaro/edepsim/BRN/graph_data'
edepsim_infile_dir = '/sdf/data/neutrino/yuntse/coherent/SNeNDSens/g4/BRN'
gampix_infile_dir = '/sdf/data/neutrino/dougl215/gampixpy/SNeNDSens/BRN'
...
if __name__ == "__main__":
    ...
    metadata = np.load(metadata_infile_dir + '/BRN_metadata.npz')
    for i in range(50):
        print("Loading file " + str(i + 1) + "/50...")
        with h5py.File(edepsim_infile_dir + '/BRN_g4_' + format(i, "04") + '.h5', 'r') as f, h5py.File(gampix_infile_dir + '/BRN_g4_gampixpy_' + format(i, "04") + '.h5', 'r') as g:
