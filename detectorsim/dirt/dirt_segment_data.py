...
metadata_infile_dir = '/sdf/home/j/jvaccaro/edepsim/dirt/graph_data'
edepsim_infile_dir = '/sdf/data/neutrino/jvaccaro/SNeNDSens/edepsim/NueArCCdirt_processed'
gampix_infile_dir = '/sdf/data/neutrino/jvaccaro/SNeNDSens/gampixpy/NueArCCdirt'
...
if __name__ == "__main__":
    ...
    metadata = np.load(metadata_infile_dir + '/dirt_metadata.npz')
    for i in range(40):
        print("Loading file " + str(i + 1) + "/40...")
        f = h5py.File(edepsim_infile_dir + '/nueArCC_sns_g4_' + format(i, "04") + '-processed.h5', 'r')
        g = h5py.File(gampix_infile_dir + '/nueArCC_sns_g4_gampixpy_' + format(i, "04") + '.h5', 'r')
    ...
    np.savez_compressed(outfile_dir + '/dirt_segment_data.npz', fenergy=data_fenergy, senergy=data_senergy, aenergy=data_aenergy,
